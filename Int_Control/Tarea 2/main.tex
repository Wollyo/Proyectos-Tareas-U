...
\Big).
\]
Y este seria nuestro resolvente para el sistema linealizado LTV. Por lo que la solución de la ecuación diferencial linealizada es:
\[
x(t)
=
\phi(t,0)x(0)
+
\int_0^t\phi(t,s)B(s)u(s)\,ds.
\]
